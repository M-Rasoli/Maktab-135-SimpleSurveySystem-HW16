...
namespace SimpleSurveySystem.Extensions
{
    public static class ConsolePainter
    {
        ...
        public static void WriteTable(IEnumerable items, ConsoleColor? headerColor = null,
        ...
        private static List<PropertyInfo> GetOrderedPropertiesByInheritance(Type type)
        {
            ...
            {
                var t = typeStack.Pop();
                props.AddRange(t.GetProperties(BindingFlags.Public | BindingFlags.Instance |
